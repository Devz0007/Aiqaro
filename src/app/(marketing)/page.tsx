...
export default function HomePage(): React.JSX.Element {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-4 max-w-screen-xl mx-auto">
          ...
          >
            ...
            therapeutic areas. Connect with leading sponsors and stay updated with <span className="text-primary font-semibold">AI-curated news</span> on 
            trials relevant to your site's interests.
          </p>
          <div 
            className="mt-4"
            style={{
      ...
      <section className="pt-16 pb-20 bg-gradient-to-b from-background to-muted/20">
        <div 
          className="container max-w-screen-xl mx-auto px-8"
          ref={dashboardRef}
        >
          <h2 className="text-4xl text-center font-semibold mb-2">
            Discover the Aiqaro Experience
          </h2>
          <p className="text-center text-lg text-muted-foreground mb-12">
            A powerful platform designed for clinical research sites
          </p>
